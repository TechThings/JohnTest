//
//  ListingOutletLocationTableViewCell.swift
//  fave
//
...
final class ListingOutletLocationTableViewCell: TableViewCell {
...
extension ListingOutletLocationTableViewCell: ViewModelBindable {
    func bind() {
