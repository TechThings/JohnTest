...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "$BUILT_PRODUCTS_DIR/AdyenCheckout/AdyenCheckout.framework"
  install_framework "$BUILT_PRODUCTS_DIR/Alamofire/Alamofire.framework"
  install_framework "$BUILT_PRODUCTS_DIR/Alexandria/Alexandria.framework"
  ...
  install_framework "$BUILT_PRODUCTS_DIR/MidtransCoreKit/MidtransCoreKit.framework"
  install_framework "$BUILT_PRODUCTS_DIR/MidtransKit/MidtransKit.framework"
